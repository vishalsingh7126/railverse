        ...
        <div className="mx-auto w-full max-w-7xl space-y-10 px-4">
          ...
          {showOnboarding && (
            <section className="mt-12">
              <h2 className="mb-4 text-lg font-semibold text-white/80">Explore Railverse Features</h2>
              <FeatureCards onAction={() => openAuthModal("signup")} />
            </section>
          )}
        </div>
      </AppShell>
